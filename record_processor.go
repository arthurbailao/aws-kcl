...
type RecordProcessor interface {
	...
	// Shutdown is called by the KCL to indicate that this record processor should
	// shutdown. After the shutdown operation is complete, there will not be any
	// more calls to any other functions of this record processor. Clients are
	// required to checkpoint at this time. This indicates that the current record
	// processor has finished processing and new record processors for the children
	// will be created.
